...
export const loadFeedToEditor = feedID => ({ type: 'LOAD_FEED_TO_EDITOR', feedID });
export const setFeedItemList = feedID => ({ type: 'SET_FEED_ITEM_LIST', feedID });
...
export const toggleItemFolding = (itemID, folding) => ({ type: 'TOGGLE_ITEM_FOLDING', itemFolding: { itemID, folding } });